...
class Scrollbar extends Component {
    ...
    componentDidMount() {
        ...
        let custom2 = new Scrollbot(".avy-blog",4).setStyle({
            "z-index":"2"
        },{
            "position": "fixed",
    ...
    render () {
        return (
            <div className="avy-scrollbar__wrapper" style={{height: "100vh"}}>
                <div className="avy-scrollbar__inner" style={{height: document.body.clientHeight}}>
                    <span>test</span>
                </div>
            </div>
        )
